...
- 書いたそばから整形後が見える（パソコンは左右、スマホは上下）
- お手本 8つ（README.md（この練習帳の説明書）／基本の書き方／AIへのお願い文／CLAUDE.md・AGENTS.md／アプリ・ホームページ・チラシを作ってもらう／議事録）。
  それぞれの頭に「なぜこう書くと伝わるか」を添えてある
